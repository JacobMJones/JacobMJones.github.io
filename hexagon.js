...
function HexagonGrid(canvasId, radius) {
	...
	this.canvasOriginX = 250;
	this.canvasOriginY = 250;

	this.canvas.addEventListener("mousedown", this.clickEvent.bind(this), false);
};

HexagonGrid.prototype.setHexGrid = function (rows, cols, originX, originY, isDebug) {
...
HexagonGrid.prototype.clickEvent = function (e) {
	...
	var tileCoord = this.getSelectedTile(localX, localY);

	for (var i = 0; i < tiles.length; i++) {
		if (tileCoord.column == tiles[i].column && tileCoord.row == tiles[i].row) {
